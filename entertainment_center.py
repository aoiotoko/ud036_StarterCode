...
akira = media.Movie(
    ...
    " whose childhood friend, Tetsuo Shima, acquires incredible powers after a"
    " motorcycle accident, eventually threatening the entire military complex"
    " amidst chaos and rebellion in the sprawling futuristic metropolis of"
    " Neo-Tokyo",
...
my_neighbor_totoro = media.Movie(
    ...
    " illness in an area hospital. As the sisters explore their new home, they"
    " encounter and befriend playful spirits in their house and the nearby"
    " forest, most notably the massive cuddly creature known as Totoro.",
...
the_matrix = media.Movie(
    ...
    " elusive figure considered to be the most dangerous man alive, can answer"
    " his question -- What is the Matrix? Neo is contacted by Trinity"
    " (Carrie-Anne Moss), a beautiful stranger who leads him into an"
    " underworld where he meets Morpheus. They fight a brutal battle for their"
    " lives against a cadre of viciously intelligent secret agents. It is a"
...
gantz_0 = media.Movie(
    ...
    " teenager; and an angry, unidentified man. Suzuki explains that they have"
    " each died and woken in the room, and have been forced to fight against"
    " waves of monsters ever since. Before Suzuki can explain further, a black"
    " orb identified as 'Gantz' announces that their next mission is about to"
    " begin. The angry man refuses to participate and is killed by Nishi, who"
    " reasons that he would have been a liability.",
...
pacific_rim = media.Movie(
    ...
    " bringing with them all-consuming war. To fight the Kaiju, mankind"
    " developed giant robots called Jaegers, designed to be piloted by two"
    " humans locked together in a neural bridge. However, even the Jaegers are"
    " not enough to defeat the Kaiju, and humanity is on the verge of defeat."
    " Mankind's last hope now lies with a washed-up ex-pilot (Charlie Hunnam),"
